...
'<div style="background:#ffffff;padding:40px 32px;">' +
  ...
  '<p style="margin:0 0 24px;font-size:15px;color:#666;line-height:1.6;">Thanks for your order, <strong style="color:#1a1a1a;">' + esc(customer.firstName) + '</strong>! Your free giveaway entries are locked in. Stickers will be mailed out once all entries are sold and the winner is drawn.</p>' +
  ...
  '<div style="margin-top:24px;padding:16px 20px;background:rgba(255,45,85,0.06);border-left:4px solid #FF2D55;">' +
    '<p style="margin:0;font-size:13px;color:#666;line-height:1.6;">' +
      '<strong style="color:#FF2D55;">' + String.fromCodePoint(0x1F3C6) + ' Giveaway Entries Included</strong><br>' +
...
'</div></body></html>';
    ...
    const textEmail = 'ORDER CONFIRMED \u2014 ' + orderId +
      '\n\nThanks for your order, ' + customer.firstName + '! Your giveaway entries are locked in. Stickers will be mailed out once all entries are sold.' +
      '\n\nOrder: ' + orderId +
